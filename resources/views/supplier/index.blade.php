                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <a href="{{ route('supplier.create') }}"
                                        class="btn btn-sm btn-primary rounded-tambak float-right">Tambah Supplier</a>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-sm btn-warning rounded-tambak"
                                                    href="{{ route('supplier.edit', $data->id) }}">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                                <button class="btn btn-sm btn-danger rounded-tambak"
                                                    onclick="deleteSupplier({{ $data->id }})"><i
                                                        class="fas fa-trash"></i></button>
                                                <form id="delete-form-{{ $data->id }}"
                                                    action="{{ route('supplier.destroy', $data->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>

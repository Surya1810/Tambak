                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            ...
                                            value="{{ $supplier->name }}" autocomplete="off">
                                        @error('name')
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('address') is-invalid @enderror"
                                            ...
                                            value="{{ $supplier->address }}" autocomplete="off">
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('phone') is-invalid @enderror"
                                            ...
                                            value="{{ $supplier->phone }}" autocomplete="off">
                                        @error('phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('contact') is-invalid @enderror"
                                            ...
                                            value="{{ $supplier->contact }}" autocomplete="off">
                                        @error('contact')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error('tempo') is-invalid @enderror"
                                            ...
                                            value="{{ $supplier->tempo }}" autocomplete="off">
                                        @error('tempo')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>

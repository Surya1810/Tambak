            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb text-black-50">
                        ...
                        <li class="breadcrumb-item active"><strong>Data Kematian Udang</strong></li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card card-outline rounded-tambak card-primary">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <h3 class="card-title">Data Kematian Udang</h3>
                                </div>
                                <div class="col-6">
                                    <a class="btn btn-sm btn-primary rounded-tambak float-right"
                                        href="{{ route('kematian.create') }}">
                                        Tambah Data
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card-body table-responsive">
                            <table id="kematianTable" class="table table-bordered text-nowrap text-center text-sm">
                                ...
                                <tbody>
                                    @foreach ($kematian as $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->jumlah }} ekor</td>
                                            <td class="text-center">
                                                <button class="btn btn-sm btn-danger rounded-tambak"
                                                    onclick="deleteKematian({{ $data->id }})"><i
                                                        class="fas fa-trash"></i></button>
                                                <form id="delete-form-{{ $data->id }}"
                                                    action="{{ route('kematian.destroy', $data->id) }}" method="POST"
                                                    style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>

                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6">
                                    <a href="{{ route('customer.create') }}"
                                        class="btn btn-sm btn-primary rounded-tambak float-right">Tambah Customer</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body table-responsive">
                            <table id="customerTable" class="table table-bordered text-nowrap text-center text-sm">
